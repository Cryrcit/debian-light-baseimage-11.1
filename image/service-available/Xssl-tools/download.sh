...
echo "Download cfssl ..."
echo "curl -o /usr/sbin/cfssl -SL https://github.com/cloudflare/cfssl/releases/download/v1.5.0/cfssl-scan_1.5.0_linux_${HOST_ARCH}"
curl -o /usr/sbin/cfssl -SL "https://github.com/cloudflare/cfssl/releases/download/v1.5.0/cfssl-scan_1.5.0_linux_${HOST_ARCH}"
chmod 700 /usr/sbin/cfssl

echo "Download cfssljson ..."
echo "curl -o /usr/sbin/cfssljson -SL https://github.com/cloudflare/cfssl/releases/download/v1.5.0/cfssljson_1.5.0_linux_${HOST_ARCH}"
curl -o /usr/sbin/cfssljson -SL "https://github.com/cloudflare/cfssl/releases/download/v1.5.0/cfssljson_1.5.0_linux_${HOST_ARCH}"
