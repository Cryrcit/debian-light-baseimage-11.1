...
ln -sf "${CONTAINER_SERVICE_DIR}/Xsyslog-ng-core/assets/config/syslog_ng_default" /etc/default/syslog-ng
ln -sf "${CONTAINER_SERVICE_DIR}/Xsyslog-ng-core/assets/config/syslog-ng.conf" /etc/syslog-ng/syslog-ng.conf
