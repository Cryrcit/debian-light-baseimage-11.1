# cryrcit/debian-light-baseimage

[![Docker Pulls](https://img.shields.io/docker/pulls/cryrcit/debian-light-baseimage.svg)][hub]
[![Docker Stars](https://img.shields.io/docker/stars/cryrcit/debian-light-baseimage.svg)][hub]
[![](https://images.microbadger.com/badges/image/cryrcit/debian-light-baseimage.svg)](http://microbadger.com/images/cryrcit/debian-light-baseimage "Get your own image badge on microbadger.com")

[hub]: https://hub.docker.com/cryrcit/debian-light-baseimage/

Latest release: 1.0 [Changelog](CHANGELOG.md)
 | [Docker Hub](https://hub.docker.com/cryrcit/debian-light-baseimage/) 
...
Table of Contents
- [cryrcit/debian-light-baseimage](#cryrcitdebian-light-baseimage)
...
- Help new users with [issues](https://github.com/cryrcit/docker-openldap/issues) they may encounter
...
In the Dockerfile we are going to:
  ...
  - Define ports exposed and volumes if needed.
        ...
        FROM cryrcit/debian-light-baseimage:1.0
        ...
        # https://github.com/cryrcit/debian-light-baseimage/blob/stable/image/tool/install-service
...
Yes in this case it's not really useful to have a secret variable like this, but a concrete example can be found in [cryrcit/openldap](https://github.com/cryrcit/docker-openldap) image.
...
- [cryrcit/openldap](https://github.com/cryrcit/docker-openldap)
- [cryrcit/keepalived](https://github.com/cryrcit/docker-keepalived)
- [cryrcit/tinc](https://github.com/cryrcit/docker-tinc)
- [cryrcit/registry-ldap-auth](https://github.com/cryrcit/docker-registry-ldap-auth)
- [cryrcit/cfssl-multirootca](https://github.com/cryrcit/docker-cfssl-multirootca)
- [cryrcit/backup](https://github.com/cryrcit/docker-backup)
- [cryrcit/backup-manager](https://github.com/cryrcit/docker-backup-manager)
- [cryrcit/mmc-agent](https://github.com/cryrcit/docker-mmc-agent)

Multiple process images:
- [cryrcit/openldap-backup](https://github.com/cryrcit/docker-openldap-backup)
- [cryrcit/mariadb](https://github.com/cryrcit/docker-mariadb)
- [cryrcit/wordpress](https://github.com/cryrcit/docker-wordpress)
- [cryrcit/roundcube](https://github.com/cryrcit/docker-roundcube)
- [cryrcit/piwik](https://github.com/cryrcit/docker-piwik)
- [cryrcit/phpMyAdmin](https://github.com/cryrcit/docker-phpMyAdmin)
- [cryrcit/phpLDAPadmin](https://github.com/cryrcit/docker-phpLDAPadmin)
- [cryrcit/keepalived-confd](https://github.com/cryrcit/docker-keepalived-confd)
- [cryrcit/tinc-etcd](https://github.com/cryrcit/docker-tinc-etcd)
- [cryrcit/postfix-gateway-confd](https://github.com/cryrcit/docker-postfix-gateway-confd)
- [cryrcit/mmc-mail](https://github.com/cryrcit/docker-mmc-mail)
- [cryrcit/mmc-web](https://github.com/cryrcit/docker-mmc-web)

Image adding light-baseimage tools to an existing image
- [cryrcit/gitlab](https://github.com/cryrcit/docker-gitlab)
...
| Xsyslog-ng-core | Syslog daemon so that many services - including the kernel itself - can correctly log to /var/log/syslog. If no syslog daemon is running, a lot of important messages are silently swallowed. <br><br>Only listens locally. All syslog messages are forwarded to "docker logs".<br><br>*This service is part of the multiple-process-stack.* |
| Xlogrotate | Rotates and compresses logs on a regular basis. <br><br>*This service is part of the multiple-process-stack.*|
| Xssl-tools | Add CFSSL a CloudFlare PKI/TLS swiss army knife. It's a command line tool for signing, verifying, and bundling TLS certificates. Comes with cfssl-helper tool that make it docker friendly by taking command line parameters from environment variables. <br><br>Also add jsonssl-helper to get certificates from json files, parameters are set by environment variables. |
...
Here simple Dockerfile example how to add a service-available to an image:
        ...
        RUN apt-get -y update \
            && /container/tool/add-service-available Xssl-tools _cron \
            && LC_ALL=C DEBIAN_FRONTEND=noninteractive apt-get install -y --no-install-recommends \
               nginx \
               php7.4-fpm
        ...
...
For example a simple image example that add service-available to this baseimage: [cryrcit/web-baseimage](https://github.com/cryrcit/docker-web-baseimage)
...
*Run tool* takes several options, to list them:
    ...
    docker run cryrcit/debian-light-baseimage:1.0 --help
    ...
    cryrcit! Light Baseimage: https://github.com/cryrcit/debian-light-baseimage
...
If a main command is set for example:
    ...
    docker run -it cryrcit/openldap:1.4.0 bash
...
Example:
    ...
    docker run -it cryrcit/debian-light-baseimage:1.0
...
A more complete example can be found [cryrcit/phpLDAPadmin](https://github.com/cryrcit/docker-phpLDAPadmin) image.
...
Can also be set by command line converted in python or json:
    ...
    docker run -it --env FRUITS="#PYTHON2BASH:['orange','apple']" cryrcit/debian-light-baseimage:1.0 printenv
    docker run -it --env FRUITS="#JSON2BASH:[\"orange\",\"apple\"]" cryrcit/debian-light-baseimage:1.0 printenv
